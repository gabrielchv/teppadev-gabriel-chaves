Para inicializar o backend, é recomendado utilizar ts-node-dev, que permite utilizar typescript diretamente com o nodejs, pode ser iniciado com o comando "npm dev" ou utilizando o yarn, "yarn dev".
